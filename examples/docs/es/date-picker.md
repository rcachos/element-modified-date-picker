...
Date Picker básico por "día" siempre visible. PRUEBAS AQUI
...
###  Calendario Siempre visible inputs ocultos
...
<template>
  <div class="block">
    ...
    <div class="demonstration">Value: {{ value15 }}</div>
    <el-date-picker
      v-model="value15"
      :calendar-always-visible="true"
      :hidden-inputs="true"
...
| calendar-always-visible        | Calendario siempre visible (elimina el comportamiento como popup) | boolean            | —                                        | false |
| hidden-inputs        | Elimina los inputs editables del data piker. Solo se debe usar si calendarAlwaysVisible es igual a true ya que sino no tenemos elemento sobre el que hacer click para activar el popup | boolean            | —                                        | false |
| only-one-calendar        | Para los data pikers de range limitar a mostar un unico calendario y no dos.| boolean            | —                                        | false |
