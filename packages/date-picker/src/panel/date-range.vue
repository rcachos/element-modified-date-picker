<template>
  <transition :name="transitionName" @after-leave="$emit('dodestroy')">
    <div
      ...
      :class="[{
        'el-date-range-picker--only-one-calendar': onlyOneCalendar,
        'has-sidebar': $slots.sidebar || shortcuts,
        'has-time': showTime,
        'el-popper': !calendarAlwaysVisible,
        'el-picker-panel--in-line': calendarAlwaysVisible
      }, popperClass]">
      <div class="el-picker-panel__body-wrapper">
        ...
        <div class="el-picker-panel__body">
          ...
          <div class="el-picker-panel__content el-date-range-picker__content is-right" v-if="!onlyOneCalendar">
            <div class="el-date-range-picker__header">
              <button
                type="button"
                @click="rightPrevYear"
